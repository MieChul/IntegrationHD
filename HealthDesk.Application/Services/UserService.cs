...
public class UserService : IUserService
{
    ...
    public async Task<bool> IsTaken(string name, string value, bool ignoreCase = false)
    {
        var found = await _userRepository.GetByDynamicPropertyAsync(name, value, ignoreCase);
