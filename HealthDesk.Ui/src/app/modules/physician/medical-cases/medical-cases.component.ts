 ...
 ngAfterViewInit(): void {
   ...
   filterMedicalCases(): void {
    ...
    if (!this.searchValue.trim() && this.preferences.length === 0) {
      ...
      this.recommendedMedicalCases = this.otherMedicalCases.filter(c => {
    ...
    this.latestMedicalCases = [...this.otherMedicalCases]
      .sort((a, b) => b.id - a.id)
      .slice(0, 6);

    // Trending: top 6 sorted by descending likeCount.
    this.trendingMedicalCases = [...this.otherMedicalCases]
